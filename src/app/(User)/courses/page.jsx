...
import FAQ from "@/components/Animation/Faq";
            ...
            <div className="">
              ...
              <div className=" mx-3">
                ...
                <div className="mt-4 text-sm">
                  Notes & videos via <strong>Google Classroom</strong>; every
                  step is recorded for practice.
                </div>
              </div>
            </div>
          </div>
