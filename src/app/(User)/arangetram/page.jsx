      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          <h1 className="text-4xl font-bold font-['Cinzel'] mb-4">
            <span className="dance-ornament">Arangetram</span> Request Form
          </h1>
          <p className="text-lg text-gray-600">
            Fill in the details step by step to plan your Arangetram event.
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="flex justify-between mb-6">
            {steps.map((label, index) => (
              <div
                key={index}
                className={`flex-1 text-center text-sm font-semibold cursor-default ${
                  index === step ? "text-orange-600" : "text-gray-400"
